  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <section className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 shadow-2xl">
        <p className="text-xs font-bold uppercase tracking-[0.22em] text-cyan-300">Privacy policy</p>
        <h1 className="mt-3 text-4xl font-black text-white">GeoShield AI privacy policy</h1>
        <div className="mt-6 space-y-6 text-sm leading-8 text-white/70">
